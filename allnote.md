...
<iframe width="720" height="405" src="https://www.youtube.com/embed/y7l5QHRY_AI" title="How to make a profit while making a difference | Audrey Choi" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

<joe-abtn
  color="#ffa500"
  icon="fa-bell"
  href="https://www.ixigua.com/7260029600867025408"
  radius="3px"
  content="上方看不了？点这个"></joe-abtn>
...
<joe-abtn
  ...
  radius="3px"
  content="论文初稿模版 - 点击跳转查看"></joe-abtn>
...
##### Study task 2.1 Conjunctions 连词
...
- Addition - In addition, furthermore, and/also, moreover
- result - thus, consequently, as a result.
- Reason - since, as, because, due to...
- opposition/contrast - however, but, although, while, despite, nevertheless, yet...
- Example - for instance, such as, for example
- Time - when, then, currently...
...
<iframe width="720" height="405" frameborder="0" src="https://www.ixigua.com/iframe/7259941686388884023?autoplay=0" referrerpolicy="unsafe-url" allowfullscreen></iframe>
...
##### Session 7 Seminar speaking skills: interrupting 


<joe-abtn
  color="#409eff"
  icon="fa-bell"
  href="https://www.suiu.cc/archives/interrupting"
  radius="3px"
  content="研讨会技巧：打断 - 点击跳转查看"></joe-abtn>


Task 7.1 Listening and speaking in seminars

[EAP Toolkit > Communication Skills > Listening and speaking in seminars](https://www.elanguages.ac.uk/sussex/communication/listening_and_speaking_in_seminars.html)

##### Session 8 Essay structure

<joe-abtn
  color="#409eff"
  icon="fa-bell"
  href="https://www.suiu.cc/archives/essaystructure"
  radius="3px"
  content="论文写作 结构 - 点击跳转查看"></joe-abtn>

##### Self study4 Cohesion 连贯代词
<joe-abtn
  color="#409eff"
  icon="fa-bell"
  href="https://aeo.sllf.qmul.ac.uk/writing/cohesion-and-coherence/"
  radius="3px"
  content="论文写作-连贯代词 - 点击跳转查看"></joe-abtn>
...
- abstract : a brief summary of the research 
  摘要:研究综述
- introduction : establishes context, retionale, and aims of research 
  引言:建立研究的背景、理论和目的
- Literature Review : reading and theories that relate to the research 
  文献综述:与研究相关的阅读和理论
- Methodology:design and procedures of data collection 
  方法论:数据收集的设计和程序
- Results : main findings of the research 
  结果:主要研究结果
- Discussion : analysis of research findings in relation to theory 
  讨论:分析与理论相关的研究成果
- Conclusion : summarises and points to future research 
  结论:总结并指出未来的研究方向


##### Session 2 TED Talk - Tim Urban 'Inside the mind of a master procrastinator'

<iframe width="720" height="405" frameborder="0" src="https://www.ixigua.com/iframe/7261817662911545897?autoplay=0" referrerpolicy="unsafe-url" allowfullscreen></iframe>
</br>
...
用简洁明了的句子，用于概括论文的主要观点和论证方向

- one or two sentences, towards the end of the introduction 一到两句话，在引言的末尾
- an idea with an opinion / judgement that can be discussed, argued and explained with supporting evidence 一个带有观点/判断的想法，可以用支持性的证据进行讨论、论证和解释
- important because it signposts the argument of the author to the reader and guides the argument within the essay. 重要的是隐私它向读者指明了作者的论点，并指导了文章中的论点。

A thesis statement is NOT:
- a topic (eg. alternative education)
- a fact 
- a statement expressing 2 sides of an argument equally 平等地表达了一个论点的两方面的陈述

### 【listening】听力部分 <a id="listening"></a> 
...
### 【reading】阅读部分 <a id="reading"></a> 


### 【speaking】演讲部分 <a id="speaking"></a> 
